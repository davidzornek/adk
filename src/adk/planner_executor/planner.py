...
_OUTPUT_PLAN_TOOL_NAME = "output_plan"
...
_OUTPUT_PLAN_TOOL = cast(
    ToolParam,
    {
        "name": _OUTPUT_PLAN_TOOL_NAME,
        "description": "Output the ordered plan of executor steps as structured data.",
        "input_schema": PlanThenActArtifact.model_json_schema(),
    },
)
_OUTPUT_PLAN_TOOL_CHOICE = cast(
    ToolChoiceToolParam,
    {"type": "tool", "name": _OUTPUT_PLAN_TOOL_NAME},
)
...
def build_plan_then_act_planner(
    ...
    *,
    ...
    return AnthropicRunnable(
        ...
        tools=[_OUTPUT_PLAN_TOOL],
        tool_choice=_OUTPUT_PLAN_TOOL_CHOICE,
